...
import dps_01_build_type.dp04_prototype.shallow.example2.concrete_prototype.Resume;
...
public class Test {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //使用使用的是浅克隆,所以resume2.workExperience.company的改变同样会影响到
    //resume.workExperience.company和resume3.workExperience.company
    //注意打印结果中的工作经历(三个人的工作经历完全一样)
