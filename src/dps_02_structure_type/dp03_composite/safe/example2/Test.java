package dps_02_structure_type.dp03_composite.safe.example2;

import java.util.List;

import dps_02_structure_type.dp03_composite.safe.example2.component.AbsFile;
import dps_02_structure_type.dp03_composite.safe.example2.composite.Folder;
import dps_02_structure_type.dp03_composite.safe.example2.leaf.File;
...
public class Test {
  ...
  private static void printTree(AbsFile ifile) {
    ...
    if (ifile == null) {
      ...
      List<AbsFile> children = ((Folder) ifile).getChildren();
